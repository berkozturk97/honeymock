          ...
          <div>
            ...
            <Grid container spacing={24}>
              <Grid item sm={3} xs={12}>
                <h2 className={'desc-table'}>Compare you verse others</h2>
              </Grid>
              <Grid item sm={7} xs={12}>
                <h1 className={'card-title-text'}> Comparison Chart Module</h1>
                <h2 className={'desc'}>Lorem ipsum dolor sit amet.</h2>
                <h2 onClick className={'link-text'}>
                  Join Now >
                </h2>
                <TableContainer
            ...
            <Grid container spacing={24}>
              ...
              <Grid item sm={6} xs={12}>
                <div className={'card-box-right'}>
                  ...
                  <h2 className={'desc'}>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Temporibus maxime repellat enim nulla explicabo dolore.
                    Quaerat ipsam, enim illo incidunt ab tempore hic obcaecati
                    voluptas amet nobis natus praesentium. Vitae doloremque
                    magnam dicta porro atque sequi deleniti possimus aliquam
                    quasi.
                  </h2>
                  <h1 className={'card-title-text'}>
                    Hire Quicker Lorem Ipsum
            ...
            <Grid container spacing={24}>
              <Grid item sm={6} xs={12}>
                <Grid container spacing={12} alignContent={'stretch'}>
                  <Grid item sm={12} xs={12}>
                    <h1 className={'descMainTitle-last'}>Building your company with us points
                    </h1>
                  </Grid>
                  <Grid item sm={6} xs={12}>
                ...
                <Grid item sm={6} xs={12}>
                <div className={'desc-container'}>
                      <h1 className={'descSubTitle-last'}>Build your employer brand</h1>
                      <h2 className={'desc-last'}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quisquam molestias laborum ut obcaecati qui voluptatem! A delectus debitis consectetur quis totam corrupti, mollitia nostrum corporis ab sint pariatur distinctio!
                      </h2>
                    </div>
                  </Grid>
                  <Grid item sm={6} xs={12}>
              ...
              <Grid item sm={6} xs={12}>
                ...
                <Grid container spacing={12}>
                <Grid item sm={6} xs={12}>
                <div className={'desc-container-last'}>
                      <h1 className={'descSubTitle-last'}>Build your employer brand</h1>
                      <h2 className={'desc-last'}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quisquam molestias laborum ut obcaecati qui voluptatem! A delectus debitis consectetur quis totam corrupti, mollitia nostrum corporis ab sint pariatur distinctio!
                      </h2>
